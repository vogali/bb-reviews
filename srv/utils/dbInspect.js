...
async function formatGraphQL(object, fields, constraints, type) {
	let cdstable = "";
	if (type === "view") {
		object[0].VIEW_NAME = object[0].VIEW_NAME.replace(/\./g, "_");
		object[0].VIEW_NAME = object[0].VIEW_NAME.replace(/:/g, "");		
		cdstable += `type ${object[0].VIEW_NAME} {\n `;
	} else {
		object[0].TABLE_NAME = object[0].TABLE_NAME.replace(/\./g, "_");
		cdstable += `type ${object[0].TABLE_NAME} {\n `;
	}
...
module.exports.formatGraphQL = formatGraphQL;
